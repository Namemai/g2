...
ki = LineClient("evg19162@zzrgg.com","mai06555mai")
...
kk = LineClient("bvm01150@bcaoo.com","mai06555mai")
...
kc = LineClient("qic36905@bcaoo.com","mai06555mai")
...
km = LineClient("mmk27668@bcaoo.com","mai06555mai")
...
kb = LineClient("dde22250@bcaoo.com","mai06555mai")
...
kn = LineClient("eor68399@eoopy.com","mai06555mai")
...
ko = LineClient("pcu51204@bcaoo.com","mai06555mai")
...
sw = LineClient("tst19227@eoopy.com","mai06555mai")
...
Gmid = ko.getProfile().mid
Zmid = sw.getProfile().mid
KAC = [cl,ki,kk,kc,km,kb,kn,ko,sw]
ABC = [cl,ki,kk,kc,km,kb,kn,ko,sw]
...
wait = {
    ...
    "message":"คุนโดนผมบล็อคไว้กรุนารอผมมาปลด",
}
